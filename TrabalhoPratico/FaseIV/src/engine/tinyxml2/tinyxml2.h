...
public:
    ...
    void Trace(const char *name) {
        printf(
            ...
            "blocks=%d\n",
            name, _maxAllocs, _maxAllocs * ITEM_SIZE / 1024, _currentAllocs, ITEM_SIZE, _nAllocs,
            _blockPtrs.Size());
    }
...
/**
   ...
   Nodes that are always leafs are simply called with Visit(). If you return
   'true' from a Visit method, recursive parsing will continue. If you return
   ...
   interesting to you. Generally Accept() is called on the XMLDocument, although
   all nodes support visiting. You should never change the document from a
   callback.
        @sa XMLNode::Accept()
*/
...
public:
    ...
    */
    ...
    /** Accept a hierarchical visit of the nodes in the TinyXML-2 DOM. Every node
       ...
       back via the XMLVisitor interface. This is essentially a SAX interface for
       TinyXML-2. (Note however it doesn't re-parse the XML for the callbacks, so
       the performance of TinyXML-2 is unchanged by using this interface versus
       any other.) The interface has been based on ideas from:
...
public:
    ...
    */
    ...
    /** Convenience function for easy access to the text inside an element.
       ...
       null is returned. This is a convenient method for getting the text of
...
/**
   ...
   TinyXML-2 DOM structure. It is a separate utility class. Take an example:
        @verbatim
        <Document>
